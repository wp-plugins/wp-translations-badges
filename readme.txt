...
* Badges link to Transifex user page or project
...
Go to Plugins and then search for "WP-Translations Badges". A few more clicks and that's it.
...
= 1.0.6 (Sept 09, 2014) =
Ready for WP 4.0
Added Nederlands (Dutch) & Slovenčina (Slovak) languages props @wp-teams

= 1.0.5 (July 31, 2014) =
Add missing file
Added Ελληνικά (Greek) language props @wp-teams

= 1.0.4 (July 8, 2014) =
Badge links now to Transifex user or project page props @grappler
Added Türkçe (Turkish), Deutsch (German), Italiano (Italian) languages props @wp-teams

= 1.0.3 (May 13, 2014) =
* Fixed badge centering issue props @danbpfr
* Added Khmer and Brazilian languages props @wp-teams
* Fixed typos errors
